function FDCPClient(){
this.cpHost="http://civilization.itgo.com/fs_img/js/unitedonline.cleanprint.net";
this.divid="2412";
this.refid="2361";
this.rt="i;";
this.cpstatus=false;
...
this.blkwidth=0;
this.xpathLib="";
this.shost="http://civilization.itgo.com/fs_img/js/secure-unitedonline.cleanprint.net";
this.hosted="fd";
...
var re=new RegExp("http://civilization.itgo.com/fs_img/js/[^.]+.[^.]+$");
var _4=wh.search(re);
if(_4>0){
wh=wh.substring(_4);
}
...
this.pthosts="http://civilization.itgo.com/fs_img/js/formatdynamics.com,cleanprint.net";
